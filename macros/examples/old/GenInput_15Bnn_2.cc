...
void GenInput_15Bnn(){
  ...
  TFile *file = new TFile("./root/Gen/15BnnInp_2.root","recreate");
  ...
  TFile *fileparam = new TFile("./root/Gen/15BnnInpParam_2.root","recreate");
  ...
  for (int i=0;i<simnum;++i){
    ...
    scat_ang = 0;//scat_deg/(180./TMath::Pi());//rad
